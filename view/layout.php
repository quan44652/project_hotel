                ...
                <div class="banner__content">
                    ...
                    <div class="seaarch_room">
                        <form action="">
                            ...
                            <button class="btn"><i class="fa-solid
                ...
                <div class="services section-m1">
                    <div class="row">
                        <div class="service-item col-4">
                            <div class="service">
                                <div class="service-img">
                                    <img src="../public/services/service-4.jpg"
                                        alt="">
                                </div>
                        ...
                        <div class="service-item col-4">
                            <div class="service">
                                <div class="service-img">
                                    <img src="../public/services/service-2.jpg"
                                        alt="">
                                </div>
                                <div class="service-content">
                                    <h1>Pool</h1>
                        ...
                        <div class="service-item col-4">
                            <div class="service">
                                <div class="service-img">
                                    <img src="../public/services/service-1.jpg"
                                        alt="">
                                </div>
                                <div class="service-content">
                                    <h1>Lounge Bar</h1>
                    ...
                    <div class="room-width row">
                        ...
                        <div class="room-item col-4">
                            <div class="room">
                                <div class="room-img">
                                    <img height="240px"
                                        src="../public/blog/blog-1.jpg" alt="">
                                </div>
                                <div class="room-content">
                                    <ul class="room-space">
                                        <li>
