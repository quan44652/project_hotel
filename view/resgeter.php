            ...
            <div class="modal_overlay">
                <div id="signUp" class="auth_form ">
                    <div class="auth_form__container">
                        ...
                        <p>Bạn đã có tài khoản? <a href="../view/model.php?act=login">Đăng nhập</a>| <a href="./layout.html">Trở về</a> </p>
                        <form action="../view/model.php?act=resgeter" method="post">
                            <div class="form-group">
                                <label for="" class="form-lable">Tên đầy đủ</label>
                                <input name="full_name" id="fullname" type="text">
                                <span class="form-message"></span>
                            </div>
                            <div class="form-group ">
                                <label for="" class="form-lable">Email</label>
                                <input name="email" id="fullname" type="text">
                                <span class="form-message"></span>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <input name="comfirm_password" id="fullname" type="text">
                                <span class="form-message"></span>
                            </div>
                       
                            <div class="form-group ">
                                <label for="" class="form-lable">Phone</label>
                                <input name="phone" id="fullname" type="text">
                                <span class="form-message"></span>
                            </div>
                            <div class="form-group ">
                                <label for="" class="form-lable">Địa chỉ</label>
                                <input name="address" id="fullname" type="text">
                                <span class="form-message"></span>
                            </div>
